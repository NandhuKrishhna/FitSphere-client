  ...
  return (
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-indigo-900 to-black">
      ...
      <div className="flex gap-6 w-full p-6 items-start">
        {/* Notifications List */}
        <div
          className={`h-[calc(100vh-3rem)] bg-gray-900 rounded-xl overflow-hidden shadow-2xl transition-all duration-300 flex-1 ${
            ...
            {filteredNotifications.length === 0 ? (
              ...
              filteredNotifications.map((notification: Notification) => (
                <div
                  ...
                  className={`border-b border-gray-800 p-4 cursor-pointer transition-all duration-200 ${
                    selectedNotification?._id === notification._id ? "bg-indigo-900/30" : "hover:bg-gray-800/70"
                  }`}
                    ...
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-gray-700">
                        {notification.metadata?.profilePicture ? (
                          <img
                            src={notification.metadata.profilePicture || "/placeholder.svg"}
                            alt="User Avatar"
            ...
            <div className="bg-gray-800 p-6 relative">
              ...
              <div className="flex items-center gap-5">
                <div className="w-20 h-20 rounded-full border-4 border-indigo-500/30 overflow-hidden flex items-center justify-center bg-indigo-600 shadow-lg shadow-indigo-500/20">
                  {selectedNotification.metadata?.profilePicture ? (
                    <img
                      src={selectedNotification.metadata.profilePicture || "/placeholder.svg"}
                      alt="Profile"
                      className="w-full h-full object-cover"
                    />
                  ) : (
